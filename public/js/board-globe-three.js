 ...
 * Shader Rayleigh + texture nuit (city lights) + normal map + étoiles.
 */
...
class RdmBoardGlobe {
  ...
  mount() {
    ...
    try {
      ...
      this.nightMesh.visible = false; // caché jusqu'au chargement
      ...
      Promise.all([
        ...
        loadTex(NORMAL_TEX),
        loadTex(NIGHT_TEX),
      ]).then(([dayTex, cloudTex, normalTex, nightTex]) => {
